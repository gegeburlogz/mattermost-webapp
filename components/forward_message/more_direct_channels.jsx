...
export default class MoreDirectChannels extends React.Component {
    static propTypes = {
        ...
        forwardedMessage:PropTypes.string,
        /*
        ...
        actions: PropTypes.shape({
            ...
            toForwardDirectMessageChannel: PropTypes.func.isRequired,
    ...
    handleSubmit = (values = this.state.values) => {
        ...
        window.localStorage.setItem('forwarded', this.props.forwardedMessage);
        if (userIds.length === 1) {
          actions.toForwardDirectMessageChannel(userIds[0], this.props.forwardedMessage).then(done);
            // actions.openDirectChannelToUserId(userIds[0]).then(done);
        } else {
          actions.toForwardDirectMessageChannel(userIds,this.props.forwardedMessage).then(done);
        ...
        return (
            ...
            >
                <Modal.Header closeButton={true}>
                    <Modal.Title>
                        <FormattedMessage
                            id='forward_message.title'
                            defaultMessage='Forward Messages'
                        />
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
